...
with pm.Model() as model1:
    ...
    ## Define prior for nu, the degrees of freedom
    nu = pm.DiscreteUniform('nu', lower=1, upper=100)

    ## Define the likelihood
    likelihood = pm.StudentT('likelihood', mu=ymodel, sd=sigma_y, nu=nu, observed=y)
...
with model1:
    ...
    # the NUTS step does not work for discrete parameters like nu
    # but PyMC changes it automatically so we don't need to worry
